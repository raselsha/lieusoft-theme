	...
	<div class="container hero__grid">
		<div class="hero__content">
			...
			<h1 class="hero__title">
				<?php esc_html_e( 'Doctor Appointment', 'lieusoft' ); ?>
				<span class="text-primary"><?php esc_html_e( 'Booking Plugin', 'lieusoft' ); ?></span>
			</h1>
			<p class="hero__lead">
				<?php esc_html_e( 'A complete appointment booking solution for doctors, clinics and hospitals. Easy scheduling, secure payments and better patient management.', 'lieusoft' ); ?>
			</p>
			...
			<ul class="check-list check-list--grid">
				...
				<li><?php echo lieusoft_icon( 'check-circle' ); ?><?php esc_html_e( 'Doctor & Schedule Management', 'lieusoft' ); ?></li>
			...
			<div class="device-mock device-mock--wide">
							...
							<div class="device-mock__columns">
								<div>
									...
									<svg class="device-mock__chart" viewBox="0 0 150 70" preserveAspectRatio="none" aria-hidden="true">
										<polyline points="0,50 25,42 50,48 75,20 100,32 125,12 150,24" fill="none" stroke="#2454F5" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
									</svg>
								</div>
								<div>
				...
				<div class="device-mock__phone">
					<div class="device-mock__phone-inner">
						...
						<div class="device-mock__phone-field"><span><?php esc_html_e( 'Doctor', 'lieusoft' ); ?></span><strong><?php esc_html_e( 'Dr. Sarah Johnson', 'lieusoft' ); ?></strong></div>
						...
						<span class="device-mock__phone-btn"><?php esc_html_e( 'Confirm Booking', 'lieusoft' ); ?></span>
					</div>
				</div>
			</div>
		</div>
